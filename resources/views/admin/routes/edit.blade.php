                ...
                <div class="form-container">
                    ...
                    <form action="{{ route('routes.update', $route->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $route->name) }}" required autofocus>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <button type="submit" class="form-submit">Update Route</button>
                        </div>
                    </form>
                </div>
