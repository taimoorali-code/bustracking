        ...
        <div class="d-aside-right-bar bg-grey">
            ...
            <div class="admin-content-right">
                ...
                <div class="form-container">
                    <h2 class="form-title">Register New Buss</h2>
                    <form action="{{ route('buses.store') }}" method="POST">
                        @csrf
                        <!-- Rule Name Field -->
                        <div class="mb-3">
                            <label for="bus_number" class="form-label">Buss Number</label>
                            <input type="text" id="bus_number" name="bus_number" class="form-control" value="{{ old('bus_number') }}" required autofocus>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="capacity" name="capacity" class="form-control" value="{{ old('capacity') }}" step="0.01" required>
                        </div>
            
                        <!-- Submit Button -->
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <button type="submit" class="form-submit">Register Buss</button>
                        </div>
                    </form>
                </div>
            </div>
