                ...
                <div class="form-container">
                    ...
                    <form action="{{ route('drivers.update', $driver->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" type="email" name="email" class="form-control" value="{{ old('email', $driver->email) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Leave blank if you don't want to update the password.</small>
                        </div>
                
                        <!-- Submit Button -->
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <button type="submit" class="form-submit">Update Driver</button>
                        </div>
                    </form>
                </div>
