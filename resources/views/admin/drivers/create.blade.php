        ...
        <div class="d-aside-right-bar bg-grey">
            ...
            <div class="admin-content-right">
                ...
                <div class="form-container">
                    <h2 class="form-title">Register New Driver</h2>
                    <form action="{{ route('drivers.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="email" type= "email" name="email" class="form-control" required>{{ old('email') }}</textarea>
                        </div>
            
                        <!-- Fine Amount Field -->
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="text" id="password" name="password" class="form-control" value="{{ old('password') }}" step="0.01" required>
                        </div>
            
                        <!-- Submit Button -->
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <button type="submit" class="form-submit">Register Driver</button>
                        </div>
                    </form>
                </div>
            </div>
